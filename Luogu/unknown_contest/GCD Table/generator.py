...
if __name__ == "__main__":
    ...
    #             for t in range(20):
    #                 Ans = 2 ** i * 3 ** j * 5 ** k * 7 ** t
    #                 if Ans <= 1000000000 and len(a) < 500:
    #                     a.append(Ans)
    # while len(a) < 500:
    ...
    # for i in range(n):
    #     for j in range(n):
    #         Ans.append(math.gcd(a[i], a[j]))
    # random.shuffle(Ans)
    # print(' '.join(map(str, Ans)))

    print(50)

    a = [5, 49, 58, 65, 66, 76, 90, 157, 157, 169, 181, 196, 206, 245, 274, 298, 311, 521, 537, 551, 596, 603, 681, 682, 774, 781, 808, 820, 838, 840, 956, 47835122, 49742744, 161031079, 243251918, 291019584, 342337356, 379684721, 442238384, 462367280, 484872238, 503052452, 544945400, 615669834, 660573866, 679253423, 810225238, 814163587, 828854703, 869722994]
